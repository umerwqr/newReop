...
function GuideCard({ guide , question }) {
  ...
  return (
    <div className="flex p-4 justify-center  bg-white sm:flex-row flex-col ">
      ...
      <div className="py-4 justify-center items-center flex flex-col items-center sm:items-start">
        <div className=' w-60 h-40 flex items-center justify-center rounded-lg px-10 Font-[500px] bg-blue-900 text-white'><p className=" ml-1">
