...
export default function Quiz() {
    ...
    const handleBookmark = async (e) => {
        ...
        try {
            const response = await axios.post('/api/set_unbookmark_mcq', { key: 'Vx0cbjkzfQpyTObY8vfqgN1us', user_id: userObject?.data.user_id, mcq_id: mcqObject?.id })
                            ...
                            <div className="w-full">
                                <div className="w-full flex flex-col ">
                                  ...
                                  ${isAanswer && isASelected && "bg-yellow-400" || !isAanswer && isASelected && "bg-red-500" || !isASelected && isAanswer && "bg-yellow-400"
                                                    ...
                                                    >
                                                        {isAanswer && <div>  <div dangerouslySetInnerHTML={{ __html: (mcqObject.explanation) }} /> </div>}
                                                    </div>}
                                                </div>
                                                <div>
                                                    <div
